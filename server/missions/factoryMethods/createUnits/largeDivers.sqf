...
// Rifleman
_man2 = _group createUnit ["O_Soldier_A_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
...
// Rifleman
_man3 = _group createUnit ["O_Soldier_A_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
...
// Rifleman
_man4 = _group createUnit ["O_Soldier_A_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
...
// Rifleman
_man5 = _group createUnit ["O_Soldier_A_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
...
// Rifleman
_man6 = _group createUnit ["O_Soldier_A_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
