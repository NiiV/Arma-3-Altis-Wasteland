...
private ["_result", "_m", "_missionMarkerName", "_missionType", "_startTime", "_returnData", "_randomPos", "_randomIndex", "_vehicleClass", "_box", "_box2", "_picture", "_vehicleName", "_hint", "_currTime", "_playerPresent", "_unitsAlive"];
...
_box2 setVariable ["R3F_LOG_disabled", false, true];
    _m = "Land_Money_F" createVehicle [(_randomPos select 0), (_randomPos select 1) - 10,0];
	_m setVariable ["cmoney", "2500", true];
