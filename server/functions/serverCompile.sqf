...
*/
mission_MoneyShipment = "server\missions\moneyMissions\mission_MoneyShipment.sqf" call mf_compile;
mission_MobMoney = "server\missions\moneyMissions\mission_MobMoney.sqf" call mf_compile;
//mission_SunkenTreasure = "server\missions\moneyMissions\mission_SunkenTreasure.sqf" call mf_compile;
/*
