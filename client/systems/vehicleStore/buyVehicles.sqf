...
{
	private ["_switch", "_deliveryMethod", "_playerMoney", "_price", "_dialog", "_playerMoneyText", "_colorText", "_itemText", "_handleMoney", "_applyVehProperties", "_car", "_vehType", "_vehPos", "_veh", "_uid"];
	...
	_createAndApplyapplyVehProperties = 
	{
		...
		_vehicle setVariable ["ownerId", _uid, true]; // Set owner id
