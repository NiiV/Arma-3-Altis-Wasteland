...
aActionsIDs = aActionsIDs + [player addAction["<img image='client\icons\money.paa'/> Deposit Money", "client\actions\", [], 1, false, false, "", 'player distance (nearestobjects [player, ["Land_Money_F"],  5] select 0) < 5']];
